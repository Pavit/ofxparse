...
<<<<<<< HEAD
            ...
            if invtranlist_ofx:
                ofx_obj.transaction_list = cls_.parseInvtranlist(invtranlist_ofx)
            else:
...
<<<<<<< HEAD
    def parseInvtranlist(cls_, invtranlist_ofx):
        ...
        for buymf_ofx in invtranlist_ofx.findAll('buymf'):
            fitid_tag = buymf_ofx.find('fitid')
            uniqueid_tag = buymf_ofx.find('uniqueid')
            units_tag = buymf_ofx.find('units')
            memo_tag = buymf_ofx.find('memo')
            type_tag = buymf_ofx.find('buytype')
            if fitid_tag and uniqueid_tag and units_tag and memo_tag and type_tag:
                transactionList.append(
                    Tranitem(fitid_tag.contents[0].strip(),
                            uniqueid_tag.contents[0].strip(),
                            units_tag.contents[0].strip(),
                            memo_tag.contents[0].strip(),
                            type_tag.contents[0].strip()))
